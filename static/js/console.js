...
$(document).ready(function () {
  ...
  setTimeout(function(){
    $('.new_line').last().teletype({animDelay: 50, text: 'nc Sthack-2016 31337'}, function(){
      setTimeout(function(){
        $('#console').append('<p class="new_line">Bienvenue à la Sthack</p>');
        $('#console').append('<p class="new_line">Connexion en cours...</p>');
        setTimeout(function(){
          setup();
        }, 1000);
      }, 1000);
